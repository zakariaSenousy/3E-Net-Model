...
class ImageWiseModel(BaseModel):
    def __init__(self, args, image_wise_network, patch_wise_network):
        super(ImageWiseModel, self).__init__(args, image_wise_network, args.checkpoints_path + '/weightsP8_' + image_wise_network.name() + '.pth')
    ...
    def test(self, path, verbose=True, ensemble= True):
        ...
        if verbose:
            print('P8 Context-aware Patch-wise Scale 896 x 672')
