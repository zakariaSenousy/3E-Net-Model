...
class PatchWiseNetwork(BaseNetwork):
    def __init__(self, channels=1):
        ...
        print('DenseNet Network Scale 896 x 672')
        densenet = torchvision.models.densenet161(pretrained=True)
        densenet.classifier = nn.Sequential(nn.Linear(2208, 3))
...
class ImageWiseNetwork(BaseNetwork):
    def __init__(self, channels=1):
        ...
        self.features = nn.Sequential(
            ...
            nn.Conv2d(in_channels= 11 * channels , out_channels=64, kernel_size=3, stride=1, padding=1),
            nn.BatchNorm2d(64),
